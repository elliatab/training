...
- **Apple Clean Energy Charging on iPhone** - [Apple launched a feature in iOS 16.1](https://support.apple.com/en-us/HT213323) to charge devices when lower carbon-emission electricity is available.
